            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  At KnowFlow, we take your privacy seriously. This Privacy Policy explains how we collect, 
              ...
              <section>
                ...
                <ul className="list-disc pl-6 text-gray-600 space-y-2">
                  ...
                  <li>Content you create (notes, flashcards, knowledge graphs)</li>
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  If you have questions about this Privacy Policy, please contact us at privacy@knowflow.com
                </p>
              </section>
            </div>
          </div>
