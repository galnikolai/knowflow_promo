            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <section>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  By accessing or using KnowFlow, you agree to be bound by these
              ...
              <section>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                  Permission is granted to use KnowFlow for personal,
              ...
              <section>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  You retain all rights to content you create using KnowFlow.
              ...
              <section>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  KnowFlow shall not be liable for any indirect, incidental,
